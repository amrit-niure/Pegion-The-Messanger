                ...
                {sidebarOptions.map((option) => {
                  ...
                  return (
                    <li key={option.id}>
                      <Link
                        href={option.href}
                        className="text-gray-700 hover:text-indigo-600 dark:hover:text-slate-900 hover:bg-gray-50 group flex gap-3 rounded-md p-2 text-sm font-semibold dark:text-slate-200 "
                      >
                        <span className="text-gray-400 border-200 group-hover:border-indigo-600 group-hover:text-indigo-600 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border text-[0.625rem] font-medium bg-white">
